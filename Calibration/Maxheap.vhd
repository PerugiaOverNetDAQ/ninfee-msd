...
architecture Behavioral of maxheap is
            ...
            case state is
                ...
                when HEAPIFY_UP =>
                    ...
                    if current_index = 0 then
                        ...
                        if heap(current_index) > heap(parent_idx) then -- Se il figlio è maggiore del padre allora swap
                ...
                when HEAPIFY_DOWN =>
                    ...
                    if right_i < heap_count then
                        ...
                        if heap(right_idx) > heap(largest) then
                            largest := right_idx;                 -- Con := l'assegnazione è immediata
                        end if;
                    end if;
